...
class NewStaffTestCase(TestCase):
    ...
    def test_autogen_payslip(self):
        ...
        self.assertEqual(payslip.utility.all()[0].amount, 750)
        self.assertEqual(payslip.entertainment.all()[0].amount, 500)
        self.assertEqual(payslip.dressing.all()[0].amount, 750)
        self.assertEqual(payslip.education.all()[0].amount, 1000)
        self.assertEqual(payslip.domestic.all()[0].amount, 500)
...
class EditStaffTestCase(TestCase):
    ...
    def test_edit_payslip(self):
        ...
        self.assertEqual(payslip.utility.all()[0].amount, 1500)
        self.assertEqual(payslip.entertainment.all()[0].amount, 1000)
        self.assertEqual(payslip.dressing.all()[0].amount, 1500)
        self.assertEqual(payslip.education.all()[0].amount, 2000)
        self.assertEqual(payslip.domestic.all()[0].amount, 1000)
